...
public class ChiefExecutiveOfficerController extends HttpServlet {
	...
	private void deleteCEO(HttpServletRequest req) {
		...
		try {
			if (dao.delete(new ChiefExecutiveOfficer(ceoId))) {
	...
	private void updateCEO(HttpServletRequest req) {
		...
		ChiefExecutiveOfficer ceo = createCEO(req, ceoId);
	...
	private void insertCEO(HttpServletRequest req) {
		ChiefExecutiveOfficer ceo = createCEO(req, 0);
	...
	private ChiefExecutiveOfficer createCEO(HttpServletRequest req, int ceoId) {
		...
		if (ceoId == 0) {
			ceo = new ChiefExecutiveOfficer();
		} else {
			ceo = new ChiefExecutiveOfficer(ceoId);
		}
	...
	private void loadCEO(HttpServletRequest req) {
		...
		ChiefExecutiveOfficer ceo = new ChiefExecutiveOfficer(0);
